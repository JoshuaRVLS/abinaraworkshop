...
Monster::Monster(const std::string& value, Position& position, const std::string &name, double health, double attack, double defense) : Character(name, health, attack, defense), Sprite(value, position) {
  init_();
}
